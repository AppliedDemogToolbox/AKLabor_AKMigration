##########
##R code to read and tabulate Alaska Department of Labor and Workforce Development's PFD-based migration by age and sex data (vintage 2020) 
##PFDMigrationByAgeBySexBCA_v2020.xls is from
##	https://live.laborstats.alaska.gov/pop/migration.cfm (PFDMigrationByAgeBySexBCA.xls) in March 2021
##Methods (from 2017) for the PFD-based migration data: https://live.laborstats.alaska.gov/pop/estimates/data/PFDMigMethods.pdf
##
##Eddie Hunsinger, March 2021
##########
